...
const Contact = () => {
		...
		emailjs
			.send(
				...
				EMAIL_JS_TEMPLATE_ID,
				{
					...
					to_name: "Aman Rai",
					reply_to: user_email,
					to_email: "amanrai6204@gmail.com",
	...
	return (
        ...
        <div className='relative z-0 bg-black min-h-screen w-full mt-12'>  
					...
					>
						...
						<label className='flex flex-col'>
							...
							<textarea
								...
								className='py-2 px-4 rounded-lg outline-none border-none font-medium bg-gray-900'
								required
							/>
						</label>
